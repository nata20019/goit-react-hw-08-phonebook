...
import { fetchContacts, addContact, deleteContact } from '../redux/operations'; // Correct operations path
import { updateFilter } from '../redux/contactsSlice'; // Correct contactsSlice path
